    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="font-size: 18px; color: #4b5563; margin: 20px 0;">
                {{ g('لقد حصلت على وسام جديد!', 'لقد حصلتِ على وسام جديد!', $user) }}
            </p>
            ...
            <p style="color: #4b5563; line-height: 1.6; margin: 30px 0;">
                {{ g('هذا الإنجاز يعكس تفانيك والتزامك في التعلم. استمر في العمل الجاد لتحصل على المزيد من الأوسمة والإنجازات!', 'هذا الإنجاز يعكس تفانيكِ والتزامكِ في التعلم. استمري في العمل الجاد لتحصلي على المزيد من الأوسمة والإنجازات!', $user) }}
            </p>
