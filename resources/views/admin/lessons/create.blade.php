    ...
    <form method="POST" action="{{ route('admin.lessons.store') }}" id="lessonForm" enctype="multipart/form-data">
        ...
        <div class="form-grid">
            ...
            <div class="form-group full-width conditional-field" id="content_field">
                ...
                <div data-rich-editor="lessonContent" data-target="contentHidden" dir="rtl" hidden>{!! safe_html(old('content')) !!}</div>
                <textarea name="content" id="contentHidden" rows="10" dir="rtl" style="width:100%; min-height:200px; padding:12px 14px; border:2px solid #e2e8f0; border-radius:10px; font-family:inherit; font-size:15px; line-height:1.8; box-sizing:border-box;">{!! safe_html(old('content')) !!}</textarea>
