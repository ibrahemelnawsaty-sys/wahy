...
<div class="form-card">
    <h2 style="margin-bottom: 24px;">💎 إضافة قيمة جديدة</h2>
    ...
    <form method="POST" action="{{ route('admin.values.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-grid">
            <div class="form-group full-width">
                ...
                <input type="text" name="name" class="form-input" value="{{ old('name') }}" placeholder="مثال: الصدق، الأمانة، التعاون" required>
                @error('name')
            ...
            <div class="form-group full-width">
                ...
                <textarea name="description" class="form-textarea" placeholder="وصف مختصر عن القيمة...">{{ old('description') }}</textarea>
                @error('description')
                    <span style="color: #dc2626; font-size: 13px;">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <small style="color: #64748b;">0 = تلقائي (آخر قيمة)</small>
                @error('order')
                    <span style="color: #dc2626; font-size: 13px;">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="form-actions">
            <button type="submit" class="btn btn-primary">💾 حفظ القيمة</button>
