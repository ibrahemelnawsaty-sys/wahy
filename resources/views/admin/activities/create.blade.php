    ...
    <form method="POST" action="{{ route('admin.activities.store') }}">
        ...
        <div class="form-grid">
            ...
            <div class="form-group full-width">
                ...
                {{-- محرّر نصوص غنيّ (Quill) — مطابق لمحرّر الدروس --}}
                <link href="https://cdn.jsdelivr.net/npm/quill@2.0.3/dist/quill.snow.css" rel="stylesheet">
                <style>
                    #quillDescEditor { min-height: 180px; font-size: 15px; line-height: 1.9; direction: rtl; text-align: right; background: white; border-bottom-right-radius: 8px; border-bottom-left-radius: 8px; }
                    #quillDescEditor.ql-container, .ql-toolbar { border-color: #e2e8f0 !important; }
                    .ql-toolbar { border-top-right-radius: 8px; border-top-left-radius: 8px; background: #f8fafc; }
                    #quillDescEditor .ql-editor { direction: rtl !important; text-align: right !important; min-height: 180px; font-family: 'IBM Plex Sans Arabic', Tahoma, sans-serif; }
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    // رفع الصور إلى نفس endpoint الدروس
