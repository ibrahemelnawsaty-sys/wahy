                    ...
                    <td style="padding: 15px; text-align: center;">
                        <div style="display: flex; gap: 8px; justify-content: center;">
                            ...
                            @if($activity->approval_status === 'pending')
                                <button onclick="showApproveModal({{ $activity->id }})"
                                        style="background: #10b981; color: white; padding: 6px 12px; border-radius: 6px; border: none; cursor: pointer; font-size: 13px;">
                                    ✅ موافقة
                                </button>
...
function toggleScope() {
    const specific = document.querySelector('#approveForm input[name="scope"]:checked').value === 'specific';
