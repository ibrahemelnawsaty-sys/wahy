...
<form action="{{ route('admin.pages.update', $page->id) }}" method="POST" id="pageForm">
    ...
    <div class="admin-card" style="margin-bottom: 24px;">
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px;">
            <div>
                <label style="display: block; margin-bottom: 8px; font-weight: 600;">اسم الصفحة</label>
                <input type="text" name="page_name" class="admin-input" value="{{ $page->page_name }}" required>
            </div>
            <div>
                <label style="display: block; margin-bottom: 8px; font-weight: 600;">Slug</label>
                <input type="text" name="slug" class="admin-input" value="{{ $page->slug }}" required>
            </div>
            <div>
        ...
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px; margin-top: 16px;">
            <div>
                <label style="display: block; margin-bottom: 8px; font-weight: 600;">عنوان SEO (Meta Title)</label>
                <input type="text" name="meta_title" class="admin-input" value="{{ $page->meta_title }}">
            </div>
            <div>
                <label style="display: block; margin-bottom: 8px; font-weight: 600;">وصف SEO (Meta Description)</label>
                <input type="text" name="meta_description" class="admin-input" value="{{ $page->meta_description }}">
            </div>
        </div>
    </div>
