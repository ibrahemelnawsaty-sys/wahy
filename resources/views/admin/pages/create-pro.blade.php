...
<form action="{{ route('admin.pages.store') }}" method="POST" id="pageForm">
    ...
    <div class="page-info-glass">
        <div class="info-grid-3">
            <div class="glass-form-group">
                ...
                <input type="text" name="page_name" id="pageName" class="glass-input" value="{{ old('page_name') }}" placeholder="{{ g('أدخل اسم الصفحة...', 'أدخلي اسم الصفحة...') }}" required>
            </div>
            <div class="glass-form-group">
                <label class="glass-label">Slug</label>
                <input type="text" name="slug" id="slug" class="glass-input" value="{{ old('slug') }}" placeholder="يتم توليده تلقائياً..." required>
            </div>
            <div class="glass-form-group">
        ...
        <div class="info-grid-2">
            <div class="glass-form-group">
                ...
                <input type="text" name="meta_title" class="glass-input" value="{{ old('meta_title') }}" placeholder="عنوان SEO...">
            </div>
            <div class="glass-form-group">
                <label class="glass-label">وصف SEO (Meta Description)</label>
                <input type="text" name="meta_description" class="glass-input" value="{{ old('meta_description') }}" placeholder="وصف SEO...">
            </div>
        </div>
    </div>
    ...
    <div class="admin-form-actions" style="margin-top: 24px; display: flex; justify-content: space-between; align-items: center;">
        ...
        <div style="display: flex; gap: 8px;">
            ...
            <button type="submit" class="admin-btn admin-btn-primary">💾 إنشاء الصفحة (Ctrl+S)</button>
        </div>
    </div>
</form>
