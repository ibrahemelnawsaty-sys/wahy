...
<div class="form-card">
    <h2 style="margin-bottom: 24px;">🏅 إضافة شارة جديدة</h2>
    ...
    <form method="POST" action="{{ route('admin.badges.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-grid">
            <div class="form-group full-width">
                ...
                <input type="text" name="name" class="form-input" value="{{ old('name') }}" placeholder="مثال: نجم النشاط، المثابر، متوّج القيم" required>
                @error('name')
            ...
            <div class="form-group full-width">
                ...
                <textarea name="description" class="form-textarea" placeholder="وصف مختصر عن الشارة...">{{ old('description') }}</textarea>
                @error('description')
                    <span style="color: #dc2626; font-size: 13px;">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="icon" class="form-input" value="{{ old('icon', '🏅') }}" maxlength="10" id="iconInput">
            ...
            <div class="form-group">
                ...
                <div class="icon-preview" id="iconPreview">{{ old('icon', '🏅') }}</div>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="condition_type" class="form-select" id="conditionType" required>
                    ...
                    <option value="{{ $key }}" {{ old('condition_type') == $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input type="number" name="condition_value" class="form-input" value="{{ old('condition_value', 1) }}" min="0" id="conditionValue" required>
            ...
            <div class="form-group">
                ...
                <input type="number" name="coins_reward" class="form-input" value="{{ old('coins_reward', 50) }}" min="0" required>
            ...
            <div class="form-group">
                ...
                <select name="type" class="form-select" required>
                    <option value="achievement" {{ old('type', 'achievement') == 'achievement' ? 'selected' : '' }}>إنجاز</option>
                    <option value="streak" {{ old('type') == 'streak' ? 'selected' : '' }}>مواظبة</option>
                    <option value="special" {{ old('type') == 'special' ? 'selected' : '' }}>خاصّة</option>
                </select>
                @error('type')
                    <span style="color: #dc2626; font-size: 13px;">{{ $message }}</span>
                @enderror
            ...
            <div class="form-group">
                ...
                <div class="color-row">
                    <input type="color" id="colorPicker" value="{{ old('color', '#f59e0b') }}">
                    <input type="text" name="color" class="form-input" style="flex:1;" value="{{ old('color', '#f59e0b') }}" id="colorText" placeholder="#f59e0b">
                </div>
            ...
            <div class="form-group">
                ...
                <small style="color: #64748b;">0 = تلقائي (آخر شارة)</small>
                @error('order')
                    <span style="color: #dc2626; font-size: 13px;">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="form-actions">
            <button type="submit" class="btn btn-primary">💾 حفظ الشارة</button>
