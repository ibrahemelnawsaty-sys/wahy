...
@section('page-title', 'إضافة ولي أمر')
...
<div class="form-card">
    <h2 style="margin-bottom: 24px;">👪 إضافة ولي أمر جديد</h2>
    ...
    <form method="POST" action="{{ route('admin.parents.store') }}">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" name="qr_code" class="form-input" value="{{ old('qr_code') }}" placeholder="مثال: SA-PAR-0001">
            </div>
