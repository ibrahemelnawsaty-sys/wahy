...
<div class="form-card">
    <h2 style="margin-bottom: 24px;">✏️ تعديل معلم: {{ $teacher->name }}</h2>
    ...
    <form method="POST" action="{{ route('admin.teachers.update', $teacher) }}">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" class="form-input" value="{{ old('email', $teacher->email) }}" required>
            </div>

            <div class="form-group">
                <label class="form-label required">رقم الجوال</label>
                <input type="text" name="phone" class="form-input" value="{{ old('phone', $teacher->phone) }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" value="{{ $teacher->qr_code }}" readonly style="background: #f1f5f9;">
            </div>
        ...
        <div class="form-actions">
            <button type="submit" class="btn btn-primary">💾 تحديث المعلم</button>
