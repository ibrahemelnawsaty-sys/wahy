...
<script>
    ...
    // ================= احتفال/حزن مولّد ذاتياً (بلا ملفات خارجية) =================
    let _wahyAC = null;
    ...
    function celebrateCorrect() { wahyLaunchConfetti(); wahyEmojiBurst('😄', 'wahy-joy-pop'); wahyHappyChime(); }
    function celebrateWrong() { wahyEmojiBurst('😢', 'wahy-sad-shake'); wahySadTone(); }
