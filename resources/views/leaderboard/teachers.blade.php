...
<div class="container-fluid px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <div class="flex items-center gap-3 mb-2">
                <a href="{{ route('leaderboard.index') }}" class="text-green-600 hover:text-green-700">
            ...
            <p class="text-gray-600">المعلمون المميزون بناءً على إنجازات طلابهم</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div class="bg-white rounded-xl shadow-lg p-6 border-r-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-600 text-sm mb-1">إجمالي المعلمين</p>
    ...
    @if($userRank)
    <!-- User Rank Card -->
    <div class="bg-gradient-to-br from-green-600 to-emerald-600 rounded-xl shadow-lg p-6 mb-6 text-white">
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="divide-y divide-gray-100">
            ...
            <div class="flex items-center p-4 hover:bg-gray-50 transition-colors {{ $leader['rank'] <= 3 ? 'bg-gradient-to-l from-green-50' : '' }}">
                ...
                <img src="{{ $leader['avatar'] }}" alt="{{ $leader['name'] ?? '' }}"
                     ...
                     onerror="this.outerHTML='<div class=&quot;w-12 h-12 rounded-lg ml-3 flex items-center justify-center font-bold text-white&quot; style=&quot;background:linear-gradient(135deg,#10b981,#059669);font-size:18px;&quot;>{{ $initial }}</div>'">
                <div class="flex-1">
                    <div class="font-bold text-gray-800">{{ $leader['name'] }}</div>
                    <div class="text-sm text-gray-500">{{ $leader['school'] ?? '-' }} • {{ $leader['students_count'] ?? 0 }} طالب</div>
                </div>
                <div class="text-left">
