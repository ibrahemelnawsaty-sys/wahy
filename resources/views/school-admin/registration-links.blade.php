...
@section('content')
    <div class="mb-4">
        ...
        <p class="text-muted">
            ...
            {{ g('شارك هذه الروابط مع المعلمين والطلاب وأولياء الأمور للتسجيل المباشر', 'شاركي هذه الروابط مع المعلمين والطلاب وأولياء الأمور للتسجيل المباشر') }}
        </p>
    </div>
                ...
                <div class="col-md-6">
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p class="text-muted small mb-0">{{ g('انسخ الرابط وشاركه مع المعلمين/الطلاب/أولياء الأمور عبر البريد أو الواتساب', 'انسخي الرابط وشاركيه مع المعلمين/الطلاب/أولياء الأمور عبر البريد أو الواتساب') }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
...
function confirmRegenerate(formId) {
    glassNotify.confirm(
        'تأكيد تجديد الرابط',
        '{{ g('تجديد الرابط سيجعل الرابط القديم غير صالح وستحتاج لمشاركة الرابط الجديد. هل أنت متأكد؟', 'تجديد الرابط سيجعل الرابط القديم غير صالح وستحتاجين لمشاركة الرابط الجديد. هل أنتِ متأكدة؟') }}',
        function() {
