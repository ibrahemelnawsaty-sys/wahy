...
class SuperAdminController extends Controller
{
    ...
    private function parseLandingPageToBlocks()
    {
        ...
        $blocks[] = [
            ...
            'type' => 'hero',
            'content' => [
                'title' => 'منصة ' . setting('site_name', 'أثيل مكة') . '.. قيم نبوية يحيى بها الطالب',
                'subtitle' => 'من مكة المكرمة .. نبع الهدايات، انطلقت منصتنا تلهم الواردين من الطلاب والمعلمين.. تجمع بين المتعة والفائدة لتبني جيلاً فعالاً متخلقاً بقيم وأخلاق النبوة',
