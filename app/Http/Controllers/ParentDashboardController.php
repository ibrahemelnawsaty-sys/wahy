...
class ParentDashboardController extends Controller
{
    ...
    public function childDetails($childId)
    {
        ...
        return view('parent.child-detail', compact(
            'child', 'stats', 'level', 'levelProgress', 'streak', 'badges',
            'classroom', 'classRank', 'schoolRank', 'totalStudents',
            'teachers', 'recentActivities', 'chartData', 'valuesProgress',
            'weeklyActivity'
        ));
    }
