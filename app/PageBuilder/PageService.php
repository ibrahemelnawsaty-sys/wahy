        ...
        return DB::transaction(function () use ($data, $page, $userId) {
            if ($page) {
                ...
                $page->fill([
                    ...
                    'use_site_header' => array_key_exists('use_site_header', $data) ? $data['use_site_header'] : $page->use_site_header,
                    'use_site_footer' => array_key_exists('use_site_footer', $data) ? $data['use_site_footer'] : $page->use_site_footer,
            ...
            return Page::create([
                ...
                'use_site_header' => $data['use_site_header'] ?? false,
                'use_site_footer' => $data['use_site_footer'] ?? false,
