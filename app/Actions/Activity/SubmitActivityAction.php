 ...
 *
 * ⚠️ الحالة (تشخيص الأنشطة، بند #12): هذا المسار **غير موصَّل** بأيّ Route حاليّاً — مسار
 * الإنتاج الحيّ هو StudentController::submitActivity (routes/web.php). يبقى هذا الـ Action
 * المُرشَّح المُميَّز في الدستور لتوحيد الويب+الجوّال عليه لاحقاً، لكنّه يفتقر اليوم لبوّابة
 * درجة النجاح/حالة needs_review الموجودة في المسار الحيّ. **لا تفترض أنّه يعكس سلوك الإنتاج**
 * ولا تصله بمسارٍ قبل مطابقة منطقه ثمّ فحص QA (مهمّة منفصلة مُؤجَّلة تتطلّب قرارات منتج).
 *
