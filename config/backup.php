...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             * 🔴 DEV-001: استخدم 'local' + 's3' للـ off-site backup (نشر backup إلى S3).
             *
             * لتفعيل S3:
             * 1. أضف القيم في .env:
             ...
             * 2. أضف disk جديد في config/filesystems.php (يوجد بالفعل في Laravel 12 default)
             * 3. أضف 's3_backups' هنا.
             */
            'disks' => [
                'local',
                // 's3_backups', // ⚠️ فعّل عند تكوين AWS credentials
            ],
        ],
